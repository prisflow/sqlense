        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            ...
            <div className="space-y-3">
              ...
              <Select value={teacherId} onValueChange={setTeacherId} items={[{label:"不指定",value:""},...teachers.map(t=>({label:t.display_name,value:t.id}))]}>
        ...
        <TableBody>
          {classes.map(c => (
            <TableRow key={c.id}>
              ...
              <TableCell>
                <Select value={c.teacher_id || ""} onValueChange={v => editTeacher(c.id, v || null)} items={[{label:"未指定",value:""},...teachers.map(t=>({label:t.display_name,value:t.id}))]}>
